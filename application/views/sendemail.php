<!-- send email dialog -->
<div id="send_email_dialog" class="modal hide fade" tabindex="-1"
	...
	<form id="send_email_form" action="<?= base_url() ?>admin/sendEmail"
		method="post">
		<div class="modal-body">
			<div class="row-fluid">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="required span12" name="subject" id="" />
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="required span12" name="address" id="" />
					</div>
				</div>

				<div class="control-group">
					<label class="control-label"><?= lang("email_body") ?>: </label>
					<div class="controls">
